<template>
  <div class="container mt-5">
    ...
    <div class="position-fixed top-0 end-0 p-3" style="z-index: 11">
      ...
      >
        ...
        <button
          type="button"
          class="btn-close"
          @click="globalNotification.message = ''"
        ></button>
      </div>
    </div>
    ...
    >
      <i class="bi bi-plus-circle me-2"></i> Ajouter un nouveau contact
    </button>
    ...
    <div v-if="loading" class="text-center my-5">
      <div
        class="spinner-border slow-spinner"
    ...
    <div v-else class="alert alert-info">
      <i class="bi bi-info-circle"></i> Aucun contact trouvé. Cliquez sur
      "Ajouter un contact" pour commencer.
    </div>
  </div>
</template>
